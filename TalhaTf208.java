...
public class TalhaTf208 extends FighterRobot {


	private int health = 0;
	private int oppHealth = 0;
	private int myId;

	public TalhaTf208(City c, int a, int s, Direction d, int id, int MAX_HEALTH) {
		super(c, a, s, d, id, 1,3,6);
	...
	public TurnRequest takeTurn(int energy, OppData[] data) {
		...
		if (myOpp != -1) {
			...
			this.oppHealth = data[myOpp].getHealth();
